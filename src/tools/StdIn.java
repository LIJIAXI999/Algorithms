...
/**
 *                 The API of Standard Input Library's static methods
 *------------------------------------------------------------------------------
 * Public class StdIn
 * -----------------------------------------------------------------------------
 *      static  boolean  isEmpty()           if there is no left value in input stream
 *                                             return true;otherwise return false.
 *      static  int      readInt()           read a int value.
 *      static  double   readDouble()        read a double value.
 *      static  float    readFloat()         read a int value.
 *      static  long     readLong()          read a double value.
 *      static  boolean  readBoolean()       read a int value.
 *      static  char     readChar()          read a double value.
 *      static  byte     readByte()          read a int value.
 *      static  string   readString()        read a double value.
 *      static  boolean  hasNextLine()       if there is another line in the input stream
 *                                             return true;otherwise return false.
 *      static  string   readLine()          read the left in the line.
 *      static  string   readAll()           read the left in the input stream.
 */
