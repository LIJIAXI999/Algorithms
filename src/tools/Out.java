...
/**
 *                   The API of Out Library's static methods
 *-------------------------------------------------------------------------------
 * public class Out
 * -----------------------------------------------------------------------------
 *      static  void    write(int[] a,String name)      write some int values
 *      static  void    write(double[] a,String name)   write some double values
 *      static  void    write(String[] a,String name)   write some String values
 *      ......
 */
