...
/**
 *               The API of In Library's static methods
 *-------------------------------------------------------------------------
 * public class In
 * ------------------------------------------------------------------------
 *      static  int[]       readInts(String name)        read many int values
 *      static  double[]    readDoubles(String name)     read some double values
 *      static  String[]    readStrings(String name)     read some string values
 *      ......
 */
