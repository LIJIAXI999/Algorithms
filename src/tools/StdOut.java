...
/**
 *            The API of Standard Output Library's static methods
 * ---------------------------------------------------------------------------------------------
 * public class StdOut
 * ----------------------------------------------------------------------------------------------
 *      static void print(String s)            print s
 *      static void println(String s)          print s and terminate the line with a line-separator.
 *      static void println()                  print a line-separator.
 *      static void printf(String f,...)       formatted output
 *      ......
 */
...
public final class StdOut {
    ...
    /**
     * Prints an object to this stream and then terminate the line.
     *
    ...
    /**
     * Prints a character to standard output and then terminate the line.
     *
